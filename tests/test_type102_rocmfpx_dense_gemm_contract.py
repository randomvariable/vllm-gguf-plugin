...
def test_type102_dense_gemm_stays_within_weight_bounds() -> None:
    ...
    def invoke() -> torch.Tensor:
        return ggml_mul_mat_a8_triton(
            guarded.tensor, activations, GGML_TYPE_Q6_0_ROCMFPX, 5
        )

    assert_no_out_of_bounds_read(invoke, guarded, label="type 102 GEMM")
