...
GGML_TYPE_I2_S = 36
# Type 41 has two public names: ``Q1_0`` is canonical, ``Q1_0_G128`` is the
# ik_llama compatibility alias for the same on-disk format.
GGML_TYPE_Q1_0 = 41
...
QK_K = 256
Q4_0_BLOCK_BYTES = 18
Q4_0_ROCMFP4_BLOCK_BYTES = 18
Q4_0_ROCMFP4_FAST_BLOCK_BYTES = 17
Q4_1_BLOCK_BYTES = 20
Q5_0_BLOCK_BYTES = 22
Q5_1_BLOCK_BYTES = 24
Q8_0_BLOCK_BYTES = 34
Q8_0_ROCMFPX_BLOCK_BYTES = 33
Q6_0_ROCMFPX_BLOCK_BYTES = 26
Q3_0_ROCMFPX_BLOCK_BYTES = 14
Q2_0_ROCMFPX_BLOCK_BYTES = 10
Q8_1_BLOCK_BYTES = 36
Q2_K_BLOCK_BYTES = 84
...
IQ4_KS_BLOCK_BYTES = 140  # 4B row-prefix FP32 + 136B block = 140 on-disk bytes/row
IQ2_KS_BLOCK_BYTES = 72
IQ3_KS_BLOCK_BYTES = 104
IQ5_KS_BLOCK_BYTES = 172
IQ4_KSS_BLOCK_BYTES = 132
IQ2_KL_BLOCK_BYTES = 88
IQ1_KT_BLOCK_BYTES = 60
IQ2_KT_BLOCK_BYTES = 72
IQ3_KT_BLOCK_BYTES = 104
IQ4_KT_BLOCK_BYTES = 132
TQ1_0_BLOCK_BYTES = 54
TQ2_0_BLOCK_BYTES = 66
Q2_0_BLOCK_BYTES = 18
Q1_0_BLOCK_BYTES = 18
# MXFP4: 16 payload bytes plus one trailing E8M0 scale byte.
MXFP4_BLOCK_BYTES = 17
# NVFP4: four leading UE4M3 scale bytes (one per 16-weight sub-block) plus 32
# payload bytes.
NVFP4_BLOCK_BYTES = 36

BLOCK_BYTES_BY_TYPE = {
    GGML_TYPE_Q4_0: Q4_0_BLOCK_BYTES,
    GGML_TYPE_Q4_0_ROCMFP4: Q4_0_ROCMFP4_BLOCK_BYTES,
    GGML_TYPE_Q6_0_ROCMFPX: Q6_0_ROCMFPX_BLOCK_BYTES,
    GGML_TYPE_Q3_0_ROCMFPX: Q3_0_ROCMFPX_BLOCK_BYTES,
    GGML_TYPE_Q2_0_ROCMFPX: Q2_0_ROCMFPX_BLOCK_BYTES,
    GGML_TYPE_Q4_0_ROCMFP4_FAST: Q4_0_ROCMFP4_FAST_BLOCK_BYTES,
    ...
    GGML_TYPE_IQ2_K: IQ2_K_BLOCK_BYTES,
    GGML_TYPE_IQ3_K: IQ3_K_BLOCK_BYTES,
    GGML_TYPE_IQ4_K: IQ4_K_BLOCK_BYTES,
    GGML_TYPE_IQ5_K: IQ5_K_BLOCK_BYTES,
    GGML_TYPE_IQ6_K: IQ6_K_BLOCK_BYTES,
    GGML_TYPE_IQ4_KS: IQ4_KS_BLOCK_BYTES,
    GGML_TYPE_IQ2_KS: IQ2_KS_BLOCK_BYTES,
    GGML_TYPE_IQ3_KS: IQ3_KS_BLOCK_BYTES,
    GGML_TYPE_IQ5_KS: IQ5_KS_BLOCK_BYTES,
    GGML_TYPE_IQ4_KSS: IQ4_KSS_BLOCK_BYTES,
    GGML_TYPE_IQ2_KL: IQ2_KL_BLOCK_BYTES,
    GGML_TYPE_IQ1_KT: IQ1_KT_BLOCK_BYTES,
    GGML_TYPE_IQ2_KT: IQ2_KT_BLOCK_BYTES,
    GGML_TYPE_IQ3_KT: IQ3_KT_BLOCK_BYTES,
    GGML_TYPE_IQ4_KT: IQ4_KT_BLOCK_BYTES,
    ...
    GGML_TYPE_MXFP4: MXFP4_BLOCK_BYTES,
    GGML_TYPE_NVFP4: NVFP4_BLOCK_BYTES,
    GGML_TYPE_Q8_0_ROCMFPX: Q8_0_ROCMFPX_BLOCK_BYTES,
}

BLOCK_QK_BY_TYPE = {
    GGML_TYPE_Q4_0: QK,
    GGML_TYPE_Q4_0_ROCMFP4: QK,
    GGML_TYPE_Q4_0_ROCMFP4_FAST: QK,
    GGML_TYPE_Q6_0_ROCMFPX: QK,
    GGML_TYPE_Q3_0_ROCMFPX: QK,
    GGML_TYPE_Q2_0_ROCMFPX: QK,
    GGML_TYPE_Q4_1: QK,
    GGML_TYPE_Q5_0: QK,
    GGML_TYPE_Q5_1: QK,
    GGML_TYPE_Q8_0: QK,
    ...
    GGML_TYPE_IQ2_K: QK_K,
    GGML_TYPE_IQ3_K: QK_K,
    GGML_TYPE_IQ4_K: QK_K,
    GGML_TYPE_IQ5_K: QK_K,
    GGML_TYPE_IQ6_K: QK_K,
    GGML_TYPE_IQ4_KS: QK_K,
    GGML_TYPE_IQ2_KS: QK_K,
    GGML_TYPE_IQ3_KS: QK_K,
    GGML_TYPE_IQ5_KS: QK_K,
    GGML_TYPE_IQ4_KSS: QK_K,
    GGML_TYPE_IQ2_KL: QK_K,
    GGML_TYPE_IQ1_KT: QK_K,
    GGML_TYPE_IQ2_KT: QK_K,
    GGML_TYPE_IQ3_KT: QK_K,
    GGML_TYPE_IQ4_KT: QK_K,
    GGML_TYPE_TQ1_0: QK_K,
    GGML_TYPE_TQ2_0: QK_K,
    GGML_TYPE_Q2_0: 64,
    GGML_TYPE_Q1_0: 128,
    GGML_TYPE_MXFP4: 32,
    GGML_TYPE_NVFP4: 64,
    GGML_TYPE_Q8_0_ROCMFPX: QK,
}

# Type 101 has geometry metadata here for shared validation, but no GEMM
# kernel. Keep it out of the advertised GEMM set.
TRITON_SUPPORTED_TYPES = frozenset(
    type_id for type_id in BLOCK_BYTES_BY_TYPE if type_id != GGML_TYPE_Q4_0_ROCMFP4_FAST
)
